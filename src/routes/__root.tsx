    ...
    <React.Fragment>
      ...
      <div className="shadow-[0px_5px_10px_rgba(0,0,0,0.5)]  w-100 h-28 bg-wood-light border-5 border-wood-border rounded-[50px] absolute mx-auto left-0 right-0 top-[5px] ">
        <div className="h-[102px] border-6 border-wood-light rounded-[46px] bg-wood-primary  ">
          <div className="inset-shadow-[0px_5px_10px_rgba(185,147,123,0.5)] m-[5px] border-accent-white border-3 h-[81px] rounded-[34px] border-dashed text-center font-cursive font-bold text-dark-white text-[40px] pt-2 text-shadow-wood-border text-shadow-lg shadow-[0px_5px_10px_rgba(0,0,0,0.5)]">
            Pomodoro Diary
          </div>
        </div>
      </div>
